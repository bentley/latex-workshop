...
Lots of \LaTeX\ distributions over the years.

A popular version for Linux, Mac, and Windows is \TeX Live.

You can install it per machine, or to a flash drive to run anywhere.
...
\begin{frame}[fragile]{Web Interface}

Share\LaTeX\ provides a friendly browser interface.

\url{https://www.sharelatex.com/}

Enter your code and it will create a PDF.
...
\begin{verbatim}
\begin{equation}
\int_0^1 \sqrt{x} dx = \frac{2x^{3/2}}{3} + C
\end{equation}
\end{verbatim}
\begin{equation}
\int_0^1 \sqrt{x} dx = \frac{2x^{3/2}}{3} + C
...
\vspace{1em}
Examples of attractive diagrams
